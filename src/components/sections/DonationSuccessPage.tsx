      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex justify-center mb-10">
          <div className="relative flex items-center justify-center">
            <span
              className="absolute w-20 h-20 rounded-full bg-emerald-400/20 animate-ping"
              style={{ animationDuration: "1.6s" }}
            />
            <span
              className="absolute w-28 h-28 rounded-full bg-emerald-400/10 animate-ping"
        ...
        <div className="text-center mb-8">
          <p className="text-xs font-mono tracking-[0.3em] text-emerald-500 mb-4 uppercase">
            Giao dịch hoàn tất
          </p>
