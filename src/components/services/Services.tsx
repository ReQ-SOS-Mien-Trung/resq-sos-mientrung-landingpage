  ...
  return (
    <section ref={sectionRef} id="services" className="bg-white text-black">
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div
          ref={headerRef}
          className="lg:w-[45%] xl:w-[40%] relative overflow-hidden border-b lg:border-b-0 lg:border-r border-black/10"
        >
          ...
          <div className="relative p-6 sm:p-8 md:p-12 lg:p-16">
            ...
            <p className="text-sm sm:text-base text-black/60 leading-relaxed max-w-sm mb-8 sm:mb-12">
              Nền tảng hỗ trợ toàn diện trong thiên tai, kết nối nạn nhân với
              đội ngũ cứu hộ và nguồn lực cần thiết.
            </p>
        ...
        <div className="lg:flex-1" ref={contentRef}>
          ...
          <div className="border-b border-black/10">
            <div className="flex flex-col sm:flex-row">
              ...
              <div className="sm:w-1/2 p-4 sm:p-6 md:p-8 flex flex-col justify-center border-t sm:border-t-0 sm:border-l border-black/10">
                <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-[#FF5722] mb-2">
                  ResQ
                </span>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black">
            {[
              ...
              <div
                key={i}
                className={`p-4 sm:p-6 ${i % 2 !== 1 ? "border-r" : ""} ${
                  i < 2 ? "lg:border-r border-b lg:border-b-0" : "lg:border-r"
                } border-black/10 last:border-r-0`}
              >
                <span className="block text-xl sm:text-2xl md:text-3xl font-black">
                  {stat.num}
                </span>
                <span className="text-[10px] sm:text-xs text-black/40 uppercase tracking-wider">
                  {stat.label}
                </span>
              </div>
            ))}
